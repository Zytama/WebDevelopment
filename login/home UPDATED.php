...
<div>
  ...
  <p style="font-size: 20px;" class="welcome-text">Explore everything here at B-Tech.
    ...
    <form class="modal-content animate" action="info.php" method="post" name="signup">
    ...
    <form class="modal-content animate" action="info.php" method="post" name="login>
        <h2 style="text-align: center;">LOG-IN</h2>

    <div class="container">
      <label for="login-email"><b>E-mail</b></label>
      <input type="text" placeholder="Enter E-mail" name="login-email" required>
